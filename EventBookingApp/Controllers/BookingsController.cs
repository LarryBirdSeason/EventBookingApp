...
namespace EventBookingApp.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CustomerName,EventId")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CustomerName,EventId")] Booking booking)
        {
            if (id != booking.Id)
            {
                return NotFound();
